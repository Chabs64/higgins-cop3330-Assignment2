...
and the monthly payment as its arguments and returns the number of months.
...
Create a version of the program that lets the user choose whether to figure out the
