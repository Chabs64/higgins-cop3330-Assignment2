...
public class HandlingBadInput {
    ...
    public static void main(String[] args) {
        ...
        String inputString = getValidInput();

        UserRofR = Double.parseDouble(inputString);
        String print = String.format("It will take %d years to double your initial investment.",YearsToDouble(UserRofR));
        Printing(print);
    }
    ...
    public static int YearsToDouble(double RateOfReturn)
    {
        return (int) Math.ceil(72/RateOfReturn);
    }

    public static void Printing(String print)
    {
